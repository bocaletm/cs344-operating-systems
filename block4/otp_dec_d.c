 ...
 * Mario Bocaletti
 * cs344
 * otp_dec_d: server that decodes text
 *********************/
...
const char* fifoFilename = "decfifo";
...
/************************
 *  decode(): decodes param2 using param1 key
 *************************/
void decode(char* key, char* msg, int n) {
  int ASCII_A = 65;
  int SPC_ALIAS = 91;
  int i;
  int c1;
